...
export const AddEditBudgetItem = ({ 
  ...
  const [estimatedCost, setEstimatedCost] = useState(initialItem?.estimatedCost?.toString() || '');
  const [actualCost, setActualCost] = useState(initialItem?.actualCost?.toString() || '');
        ...
        >
          ...
          <View className="mb-4">
            ...
            <TextInput
              ...
              className="border border-gray-200 rounded-lg p-2"
              placeholder={t("screens.budget.items.form.categoryPlaceholder")}
            />
          </View>
